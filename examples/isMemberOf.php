...
if(isset($_GET['group'])) {
	...
	/*
	if($user->isMemberOf($_GET['group'])) {
		echo "The user is member of group '" . htmlspecialchars($_GET['group']) ."'\n";
	}
	else {
		echo "The user is <strong>not</strong> member of group '" . htmlspecialchars($_GET['group']) ."'\n";
	}
	*/
}
